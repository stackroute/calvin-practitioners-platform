...
//     }, errResult =>
//       // Log the error for internal use
//        res.status(500).send({ error: 'Internal error occurred, please try later..!' }));
//   } catch (error) {
//     // Log the Error for internal use
//     res.send({ error: 'Failed to
// complete successfully, please check the request and try again..!' });
//   }
// });
